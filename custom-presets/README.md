...
- Want your own theme preset shown here? Start customizing any theme from here using the variables, and submit in the [Discord Addons server](https://dsc.gg/discord-addons)!
- [Learn how to customize your theme!](https://8io.gitbook.io/discord-addons/customize-your-theme/customize-your-theme)
- You can see the previews directly in the [support server](https://dsc.gg/discord-addons) in a dedicated channel.
